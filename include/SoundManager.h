...
public:
    ...
    // تابع load با قابلیت تخصیص کانال اختصاصی
...
private:
    ...
    std::unordered_map<std::string, int> dedicatedChannels;  // کانال اختصاصی هر صدا
    std::unordered_map<std::string, Uint32> lastPlayTime;
    Uint32 cooldown = 100;

    int nextChannel = 0;  // برای تخصیص خودکار کانال
};
